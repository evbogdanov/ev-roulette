function EvWeapon(a,b){this.id=a;this.weapon_name=b.weapon_name;this.skin_name=b.skin_name;this.rarity=b.rarity;this.steam_image=b.steam_image;this.el=null}EvWeapon.EL_WIDTH=200;function EvRoulette(a){this.weapon_prize_attrs=a.weapon_prize_attrs;this.weapon_actors_attrs=a.weapon_actors_attrs;this.weapons=[];this.el_parent=a.el_parent;this.el_weapons=this.el=null;this.beforeparty=a.beforeparty;this.afterparty=a.afterparty}EvRoulette.N_WEAPONS=31;EvRoulette.WEAPON_PRIZE_ID=EvRoulette.N_WEAPONS-3;
EvRoulette.SPIN_SECS=8;EvRoulette.START_DELAY_MSECS=100;EvRoulette.SOUND_SPIN_INTERVAL=100;EvRoulette.IMAGE_LOAD_INTERVAL=500;EvRoulette.IMAGE_LOAD_WAIT_MSECS=1E4;EvRoulette.SOUND_START="/snd/roulette_start.wav";EvRoulette.SOUND_SPIN="/snd/roulette_spin.wav";EvRoulette.SOUND_STOP="/snd/roulette_stop.wav";
EvRoulette.prototype.set_weapons=function(){var a=this,b=[],d=a.weapon_actors_attrs.length,e=0,g=function(g,c){var h;for(h=g;h<=c;h+=1)b[h]=new EvWeapon(h,a.weapon_actors_attrs[e]),e=e===d-1?0:e+1};if(0===d)throw Error("\u041e\u0448\u0438\u0431\u043a\u0430! \u041d\u0435\u0442 \u0430\u043a\u0442\u0451\u0440\u043e\u0432.");g(0,EvRoulette.WEAPON_PRIZE_ID-1);b[EvRoulette.WEAPON_PRIZE_ID]=new EvWeapon(EvRoulette.WEAPON_PRIZE_ID,a.weapon_prize_attrs);g(EvRoulette.WEAPON_PRIZE_ID+1,EvRoulette.N_WEAPONS-
1);a.weapons=b};
EvRoulette.prototype.render=function(){var a=this,b=document.createElement("div"),d=document.createElement("div"),e=document.createElement("div"),g=0,f=0,c;b.id="ev-roulette";d.id="ev-target";e.id="ev-weapons";e.style.width=EvRoulette.N_WEAPONS*EvWeapon.EL_WIDTH+"px";a.weapons.forEach(function(a){var b=document.createElement("div"),c=document.createElement("div"),d=document.createElement("div"),f=document.createElement("img"),k=document.createElement("div"),l=document.createElement("p"),m=document.createElement("p");
